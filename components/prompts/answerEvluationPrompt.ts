export function createAnswerEvaluationPrompt(
  ...
  Evaluation guidelines: "${questionTypes} evaluation"
  ...
  - Return ONLY a valid and perfect without error JavaScript object with the following structure and with no uncessary characters/content:
  ...
  Identify possible strengths if only if it has one focusing on technical accuracy, relevance, structure, and communication style.
